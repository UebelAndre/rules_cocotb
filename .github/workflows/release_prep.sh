#!/usr/bin/env bash
# Build the rules_cocotb release archive and emit release notes.
...
#
# Side effects:
#   Writes rules_cocotb-${TAG}.tar.gz to the current directory. This
...
ARCHIVE="rules_cocotb-${TAG}.tar.gz"
